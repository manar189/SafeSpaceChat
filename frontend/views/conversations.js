...
function ConversationView(props) {
    ...
    return (
      ...
      <ScrollView style={conversationStyles.container} contentContainerStyle={conversationStyles.contentContainer}>
      <OptionButton
        icon="circle"
        label="Kalle Kula"
        msg="Tja vgd"
    ...
    return (
      <RectButton style={conversationStyles.option} onPress={onPress}>
        ...
        <View style = {conversationStyles.parentMode}>
          <MaterialCommunityIcons name={parentIcon} size={30}  style={conversationStyles.parentChild}/>
          </View>
      </RectButton>
    );
  }
